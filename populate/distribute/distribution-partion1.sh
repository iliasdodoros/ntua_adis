...
REDIS_TABLES=("web_sales web_returns web_site web_page item promotion reason ship_mode")
MONGO_TABLES=("catalog_page store_sales store_returns store customer inventory customer_address customer_demographics household_demographics income_band")
