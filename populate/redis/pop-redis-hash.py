...
def load_tpcds_data_into_redis(redis_client, table_name, tpcds_data_path):
    ...
    with open(tpcds_data_path, 'r', encoding='latin1') as csvfile:
        ...
        for i, row in enumerate(csv_reader):
            ...
            key = f"{table_name}:{table_name}:{i+1}"
...
tpcds_data_paths = {
    'dbgen_version': '/home/user/data/dbgen_version.dat',
    'customer_address': '/home/user/data/customer_address.dat',
    'customer_demographics': '/home/user/data/customer_demographics.dat',
    'date_dim': '/home/user/data/date_dim.dat',
    'warehouse': '/home/user/data/warehouse.dat',
    'ship_mode': '/home/user/data/ship_mode.dat',
    'time_dim': '/home/user/data/time_dim.dat',
    'reason': '/home/user/data/reason.dat',
    'income_band': '/home/user/data/income_band.dat',
    'item': '/home/user/data/item.dat',
    'store': '/home/user/data/store.dat',
    'call_center': '/home/user/data/call_center.dat',
    'customer': '/home/user/data/customer.dat',
    'web_site': '/home/user/data/web_site.dat',
    'store_returns': '/home/user/data/store_returns.dat',
    'household_demographics': '/home/user/data/household_demographics.dat',
    'web_page': '/home/user/data/web_page.dat',
    'promotion': '/home/user/data/promotion.dat',
    'catalog_page': '/home/user/data/catalog_page.dat',
    'inventory': '/home/user/data/inventory.dat',
    'catalog_returns': '/home/user/data/catalog_returns.dat',
    'web_returns': '/home/user/data/web_returns.dat',
    'web_sales': '/home/user/data/web_sales.dat',
    'catalog_sales': '/home/user/data/catalog_sales.dat',
    'store_sales': '/home/user/data/store_sales.dat',
}
