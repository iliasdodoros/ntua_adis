...
for i in $(seq 1 1 99)
do
cat /home/user/ntua_adis/DSGen-software-code-3.2.0rc1/query_template/query$i.tpl > query.temp # to create each query in a different file, each time write a new template name into the qlist file
