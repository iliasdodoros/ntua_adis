...
with  cross_items as
 ...
 from(
       select 'cassandra.tpcds.store' channel, i_brand_id,i_class_id
...
(select avg(quantity*list_price) average_sales
 ...
 from
 (select 'cassandra.tpcds.store' channel, i_brand_id,i_class_id,i_category_id
