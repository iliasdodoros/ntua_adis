    ...
    from
        (
            ...
            where
                redis.store_sales.store_sales.ss_sold_date_sk = cassandra.tpcds.date_dim.d_date_sk
            ...
            from
                ...
                redis.customer.customer
            where
                cassandra.tpcds.catalog_sales.cs_sold_date_sk = cassandra.tpcds.date_dim.d_date_sk
            ...
            from
                ...
                redis.customer.customer
            where
                mongodb.tpcds.web_sales.ws_sold_date_sk = cassandra.tpcds.date_dim.d_date_sk
