...
select  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    from redis.store_sales.store_sales,cassandra.tpcds.date_dim,redis.store.store,redis.household_demographics.household_demographics,redis.customer_address.customer_address 
    ...
    and redis.store.store.s_city in ('Oak Grove','Fairview','Riverside','Five Points','Midway') 
