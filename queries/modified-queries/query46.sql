...
select  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    from cassandra.tpcds.store_sales,cassandra.tpcds.date_dim,cassandra.tpcds.store,cassandra.tpcds.household_demographics,cassandra.tpcds.customer_address 
    ...
    and cassandra.tpcds.store.s_city in ('Fairview','Midway','Oak Grove','Midway','Fairview') 
    group by ss_ticket_number,ss_customer_sk,ss_addr_sk,ca_city) dn,cassandra.tpcds.customer,cassandra.tpcds.customer_address current_addr
