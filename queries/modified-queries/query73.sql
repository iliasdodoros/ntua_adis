...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and mongodb.tpcds.date_dim.d_dom between 1 and 2 
    ...
    and case when mongodb.tpcds.household_demographics.hd_vehicle_count > 0 then 
             mongodb.tpcds.household_demographics.hd_dep_count/ mongodb.tpcds.household_demographics.hd_vehicle_count else null end > 1
    ...
    group by ss_ticket_number,ss_customer_sk) dj,mongodb.tpcds.customer
