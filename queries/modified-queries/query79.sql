...
select 
  ...
  from
   (select ss_ticket_number
    ...
    and (redis.household_demographics.household_demographics.hd_dep_count = 8 or redis.household_demographics.household_demographics.hd_vehicle_count > 0)
    ...
    group by ss_ticket_number,ss_customer_sk,ss_addr_sk,mongodb.tpcds.store.s_city) ms,redis.customer.customer
