...
select 
  ...
  from
   (select ss_ticket_number
    ...
    and cassandra.tpcds.store.s_number_employees between 200 and 295
    group by ss_ticket_number,ss_customer_sk,ss_addr_sk,cassandra.tpcds.store.s_city) ms,cassandra.tpcds.customer
