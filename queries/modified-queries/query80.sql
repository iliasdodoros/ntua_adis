with ssr as (
       ...
       from
              ...
              left outer join redis.store_returns.store_returns on (
...
csr as (
       ...
       from
              ...
              left outer join cassandra.tpcds.catalog_returns on (
...
wsr as (
       ...
       from
              ...
              left outer join mongodb.tpcds.web_returns on (
...
from
       (
              select
                     'redis.store.store channel' as channel,
