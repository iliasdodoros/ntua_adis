...
MONGO_TABLES=()
REDIS_TABLES=()
CASSANDRA_TABLES=("web_sales" "catalog_sales" "catalog_page" "catalog_returns" "call_center" "warehouse" "date_dim" "time_dim" "web_returns" "web_site" "web_page" "store_sales" "store_returns" "store" "inventory" "ship_mode" "promotion" "item" "reason" "customer" "customer_address" "customer_demographics" "household_demographics" "income_band")
